...
import java.util.Random;
    ...
    */
    // [wont need]delete the key-value pair with the given key rooted at h
    ...
    ***************************************************************************/
    ...
    public static void main(String[] args) { 
        ...
        for (int i = 0; i < array.length; i++){
            ...
            st.put(String.valueOf(i),array[i]);
            
        }
       //System.out.pintln("size "+st.size(root) + " "  );

        for(int i = 0 ; i<array.length; i++){
           // System.out.println("~~~ `~~. "+isRed(root)  );
            System.out.println("st.get = " + st.get( String.valueOf(i))  ) ; 
        }

        System.out.println("  st.root="+ st.root.size() );
        System.out.println("reds count :"+reds+" blacks count: "+ blacks );
