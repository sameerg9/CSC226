...
import java.util.Random;
    ...
    ***************************************************************************/
    ...
    public float percentRed(){
        System.out.println("reds="+reds + "blacks: "+(size()-reds ));
        float r = ((float)reds *100 / (float)size() );
    ...
    public static void main(String[] args) {
        ...
        RedBlackBSTLite st = new RedBlackBSTLite();
       ...
       // inOrderTraversal(st.root);
        ...
        System.out.println("    Reds1 = " +st.reds +"       ");
